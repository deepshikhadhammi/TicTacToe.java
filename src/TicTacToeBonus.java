 ...
 * @version 1.0
 */
public class TicTacToeBonus extends Canvas {
    ...
    public static boolean winInRow(int[][] board, int row, int piece)  // check for win in a row
    {
    ...
    public static boolean winInColumn(int[][] board, int column, int piece) //checks for win in a column
    {
    ...
    public static boolean winInDiagonalBS(int [][]board,int piece) {
        ...
        for(int r =0;r<rowsIn(board);r++)  //loop that goes through every row
        {
            for(int c=0;c<columnsIn(board);c++)  //loop for every column in a row
            {
    ...
    public static boolean winInDiagonalFS(int[][] board, int piece) {
        ...
        for(int r=0;r<rowsIn(board);r++) //loop through every row on a board
        {
